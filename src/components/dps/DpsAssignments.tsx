...
export default function DpsAssignments() {
            ...
            <div className="flex justify-between items-end">
                <div className="space-y-2">
                    <h1 className="text-4xl font-black text-gray-900 tracking-tight flex items-center gap-4">
                        ...
                        DPR Plan Assignments
                    </h1>
                    <p className="text-gray-500 text-lg font-medium">Assign employees to handle daily target updates for Site DPR Schedules.</p>
                </div>
            </div>
