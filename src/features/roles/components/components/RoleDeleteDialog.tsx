...
export function RoleDeleteDialog({ open, role, isDeleting, blockedMessage, onClose, onConfirm }: RoleDeleteDialogProps) {
  return (
    <Dialog
      open={open}
      onClose={onClose}
    ...
    >
      {blockedMessage ? (
        ...
        <p className={text.body}>
          Are you sure you want to delete <span className="font-semibold text-fg">{role?.name}</span>? This action
          cannot be undone.
        </p>
      )}
    </Dialog>
