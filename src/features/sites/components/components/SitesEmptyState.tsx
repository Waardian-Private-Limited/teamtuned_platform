...
import type { SiteStatusFilter } from '../../constants/sites.constants';
...
export function SitesEmptyState({
  ...
  let title = 'Create your first site';
  let description =
    'Sites are the work locations your teams report to — offices, plants, or field locations. Add a site to start tracking attendance, budgets, and assignments.';
  let buttonLabel = 'Add Site';
