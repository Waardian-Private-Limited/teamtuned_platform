...
export default function DpsSubmissionsPage() {
    ...
    const handleRowClick = (siteId: number) => {
        // Here we could route them to a detailed view of the schedule, 
        // or back to the schedule editor for them to see what was planned.
        router.push(`/org-admin/dps/schedule/${siteId}`);
    };
            ...
            <div className="flex justify-between items-end">
                <div className="space-y-2">
                    <h1 className="text-4xl font-black text-gray-900 tracking-tight flex items-center gap-4">
                        ...
                        DPS Plan Submissions
                    </h1>
                    <p className="text-gray-500 text-lg font-medium">View the planned Daily Progress System schedules.</p>
                </div>
            </div>
