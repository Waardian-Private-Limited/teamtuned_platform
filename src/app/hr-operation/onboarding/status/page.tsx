  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        <h2 className="text-xl font-black">Onboarding Actions</h2>
        {!selected ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-col items-end gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-black text-white rounded-2xl font-black flex items-center gap-2 disabled:opacity-60"
                >
                  <Send size={18} />
                  {sendingLetter ? 'Sending...' : 'Resend Appointment Letter'}
                </button>
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-white border border-gray-200 rounded-2xl text-sm font-bold hover:border-black transition-all disabled:opacity-60"
              >
              ...
              {!selected?.hr_onboarding_verified && (
                <div className="text-xs text-gray-500 mt-2">
                  Verify onboarding to enable salary confirmation.
                </div>
              )}
              <div className="mt-3">
                <button
      ...
      {detailsOpen && selected && (
        <ModalPortal>
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
              ...
              <div className="mt-6 space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={e => setFinalSalary(e.target.value)}
                    placeholder="e.g. 5,00,000"
                    className="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:ring-4 focus:ring-blue-500/10 font-bold"
                  />
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={verifyOnboarding}
                    className="px-4 py-2 bg-black text-white rounded-2xl text-sm font-bold disabled:opacity-60"
                    disabled={selected?.hr_onboarding_verified === 1}
                  >
                    {selected?.hr_onboarding_verified === 1 ? 'Onboarding Verified' : 'Verify Onboarding'}
                  </button>
                </div>
              </div>
            </div>
